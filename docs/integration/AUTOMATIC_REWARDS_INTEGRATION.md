...
publisher_hex = "e68ef23cb6316728ae3b0f3edcc96640219275c2ed62c405578cc486a12dfac6"
...
**Test Profile:** `sigil-main` or `devnet` (account must match `move/Move.toml` `[addresses].sigil`)  
...
```bash
MODULE="0xe68ef23cb6316728ae3b0f3edcc96640219275c2ed62c405578cc486a12dfac6"
RESOURCE="0x7352fcfd4658a3181264d1ac50ccdde5c56dc73d4fbc07887e4fb24c8e109835"

# 1. Deploy (done once)
aptos move publish --profile sigil-main --package-dir move --max-gas 50000
...
aptos account fund-with-faucet --profile sigil-main --amount 1000000000
